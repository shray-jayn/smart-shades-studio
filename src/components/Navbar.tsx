      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-xl font-bold gradient-text sm:hidden">MB&M</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="tel:+13104980110" className="flex items-center space-x-2 text-sm text-muted-foreground hover:text-brand transition-colors">
              <Phone className="h-4 w-4" />
              <span>(310) 498-0110</span>
            </a>
            <Button size="sm" className="gradient-vibrant hover:opacity-90 transition-opacity">
              Get Quote
            </Button>
          </div>
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 space-y-3">
                ...
                <Button className="w-full gradient-vibrant">Get Quote</Button>
              </div>
            </div>
          </motion.div>
        )}
